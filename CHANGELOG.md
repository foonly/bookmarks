...
- sync: Implement bookmark data synchronization (e668b49)
...
### Misc
- Refactor version display to a footer (56479c1)

### v0.2.1 (2025-09-30)

### Misc
- Use flex-grow for input width (2e1d09c)
...
- save bookmarks to store (2006c65)
- use formData (3975254)
- modal handler and bookmark form. (6ad4c9f)
- Replace Vite logo with bookmark icon (f366b3b)
- Add bookmark button and modal (15a8cac)
- Add basic project setup (2b1572b)

### Misc
- Deploy files to server (0ae0e43)
- Add release workflow (65d5488)
- Add MIT license (000302d)
- Add initial README file (086546e)
